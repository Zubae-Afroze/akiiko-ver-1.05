                                ...
                                <Row className='navbar-dropdown'>
                                    <Col className='navbar-drop-list' sm={8}>
                                        <ul>
                                            ...
                                            <li>
                                                <Link to='/lifestyle/workout'><img src='/images/nav_drop/organisation_drop/pouch.png' alt='laundry_img'/>
                                            ...
                                            <li>
                                                <img src='/images/nav_drop/organisation_drop/baskets.png' alt='laundry_img'/>
                                                <div className='navbar-drop-list-label'>STATIONERY</div></li> */}
                                        </ul>
                                        <a href='/lifestyle/workout' className='navbar-drop-link'>VIEW ALL BAGS</a>
                                    </Col>
                                ...
                                <Row className='navbar-dropdown'>
                                    <Col className='navbar-drop-list' sm={8}>
                                        <ul>
                                            ...
                                            <li>
                                                <Link to='/gift/giftbag'><img src='/images/nav_drop/organisation_drop/pouch.png' alt='laundry_img'/>
                                                <div className='navbar-drop-list-label'>GIFT BAG</div></Link></li>
                                            {/* <li>
                                                <img src='/images/nav_drop/organisation_drop/baskets.png' alt='laundry_img'/>
                                                <div className='navbar-drop-list-label'>FLORAL</div></li> */}
                                            <li>
                                                <Link to='/gift/accessories'><img src='/images/nav_drop/organisation_drop/acessories.png' alt='laundry_img'/>
                                ...
                                <Row className='navbar-dropdown'>
                                    <Col className='navbar-drop-list' sm={8}>
                                        <ul>
                                            ...
                                            <li>
                                                <Link to='/storage/organisers'><img src='/images/nav_drop/travel_drop/cabin_bag.png' alt='laundry_img'/>
                                                <div className='navbar-drop-list-label'>ORGANISERS</div></Link></li>
                                            <li>
                                                <Link to='/storage/home'><img src='/images/nav_drop/travel_drop/backpack.png' alt='laundry_img'/>
                            ...
                            <Collapse in={true} onMouseLeave={this.toggleShoppingDiv}>
                                <Row className='navbar-dropdown'>
                                    <Col className='navbar-drop-list' sm={8}>
                                        <ul>
                                            <li>
                                                <Link to='/accessories/onthego'><img src='/images/nav_drop/men_drop/wallet.png' alt='laundry_img'/>
                                            ...
                                            <li>
                                                <Link to='/accessories/wallet'><img src='/images/nav_drop/men_drop/coat_cover.png' alt='laundry_img'/>
