                ...
                <Container>
                    <Row className='footer-main'>
                        ...
                        <ul className='footer-social-icons'>
                            <li><a href='https://www.instagram.com/akiiko_india/' target='_blank'><i className="lni lni-instagram-filled"></i></a></li> 
                            <li><a href='https://www.facebook.com/akiikoindia/' target='_blank'><i className="lni lni-facebook-filled"></i></a></li>
