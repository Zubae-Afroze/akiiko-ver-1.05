                ...
                <Container className='footer-brand-container'>
                    <Row className='footer-brand'>
                        ...
                        <Row className='footer-image-row'>
                            <Col className='footer-image-col-1 col-sm-4 footer-icons' sm><Link to={'/FooterLinks/#natural'}><div><img src={'/images/font_images/nature.svg'} alt='natural'/></div></Link>NATURAL</Col>
                            <Col className='footer-image-col-4 col-sm-4 footer-icons' sm><Link to={'/FooterLinks/#organic'}><div><img src={'/images/font_images/organic.svg'} alt='natural'/></div></Link>ORGANIC</Col>
                            <Col className='footer-image-col-3 col-sm-4 footer-icons' sm><div><Link to={'/FooterLinks/#sustainable'}><img src={'/images/font_images/sustainable.svg'} alt='natural'/></Link></div>SUSTAINABLE</Col>
                        </Row >
                        <Row className='footer-image-row'>
